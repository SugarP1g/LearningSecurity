...
- **按漏洞类型划分**
  - XSS
    ...
    - [深入理解浏览器解析机制和XSS向量编码](https://www.attacker-domain.com/2013/04/deep-dive-into-browser-parsing-and-xss.html)
...
- **按编程语言划分**
  ...
  - Java
    ...
    - JNDI
      ...
      - [如何绕过高版本 JDK 的限制进行 JNDI 注入利用](https://paper.seebug.org/942/#4-jdk-8u191)
      - [探索高版本 JDK 下 JNDI 漏洞的利用方法](https://tttang.com/archive/1405/#toc_snakeyaml)
